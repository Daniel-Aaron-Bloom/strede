...
pub(super) fn expand_owned(
    ...
    // See strede::Fields / strede::Disjoint. Mirrors the borrow family's
    // identically-named block in strede-derive/src/borrow/struct_.rs.
